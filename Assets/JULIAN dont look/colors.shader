...
Shader "colors"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 panner20 = ( 2.0 * _Time.y * float2( 1,1 ) + i.uv_texcoord);
...
/*ASEBEGIN
Version=15900
130;166;1054;625;1914.948;130.486;1.551959;True;False
Node;AmplifyShaderEditor.RangedFloatNode;10;-1852.805,448.2383;Float;False;Property;_hue;hue;0;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=5706A3E571867D76DE2EB794518B3A97C775E017